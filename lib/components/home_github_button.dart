...
class _HomeGithubButtonState extends State<HomeGithubButton> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(transform: GradientRotation(2*3.14*_animationController.value),stops: [0.6,1],colors: [
          Color.fromARGB(255, 163, 147, 253),Colors.white
        ]),
      ),
      child: child,
      ),
